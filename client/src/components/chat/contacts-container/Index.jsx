...
function ContactContainer() {
  ...
  useEffect(() => {
    const getContacts = async () => {
      try {
        const response = await axios.get(GET_DM_CONTACT);
